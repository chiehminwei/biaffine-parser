...
print('left {0:.1f}'.format(tleft/left*100))
print('right {0:.1f}'.format(tright/right*100))
print('root {0:.1f}'.format(troot/root*100))
print('short {0:.1f}'.format(tshort/short*100))
print('long {0:.1f}'.format(t_long/_long*100))
print('nsubj {0:.1f}'.format(tnsubj/nsubj*100))
print('dobj {0:.1f}'.format(tdobj/dobj*100))
print('conj {0:.1f}'.format(tconj/conj*100))
print('comp {0:.1f}'.format(tcomp/comp*100))
print('case {0:.1f}'.format(tcase/case*100))
print('mod {0:.1f}'.format(tmod/mod*100))
